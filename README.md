...
- **Favorites System:** Local storage integration to save and manage "My List".
...
- **API Handling:** Axios + TMDB (The Movie Database)
...
- **Sistema de Favoritos:** Integração com Local Storage para salvar e gerenciar sua lista.
...
- **Integração de API:** Axios + TMDB (The Movie Database)
